...
export const InstanceGeneralLayout = ({ children }: PropsWithChildren) => {
  return (
    <div className="min-h-screen w-full pb-[52px]">
      <div className="fixed left-[0px] top-[0px] z-[-1] h-screen w-screen bg-[#090A13] bg-[url('./images/bg-effect.png')] bg-cover  bg-center  bg-no-repeat" />
      <NodeTopBar />
