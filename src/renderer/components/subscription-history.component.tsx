  ...
  return (
    <div className="flex min-h-[100vh] w-full flex-col bg-[#090A13] bg-[url('./images/bg-effect.png')] bg-cover  bg-center  bg-no-repeat  pt-32 lg:flex-row">
      ...
      <div className="m-10 w-fit text-white lg:m-0 lg:px-20">
        ...
        <InstanceInfo
          div1Heading={t('active_subscription_label', { ns: 'general' })}
          div1SubHeading={+12.21}
          div1Text="10 H"
          div2Heading={t('total_subscription_label', { ns: 'general' })}
          div2SubHeading={-2.21}
          div2Text="100 h"
          div3Heading={t('highest_cost_subscription_label', { ns: 'general' })}
          div3SubHeading={-2.21}
          div3Text="12h : 31m : 2s"
        />
